...
const COMPSCI_FLASHCARDS = [
  ...
  },
  {
    id: 6,
    question:
      "What is the Time Complexity of the Worst-Case Uniform Binary Search?",
    answer: "O(logn)",
    options: ["O(nlogn)", "O(logn)", "O(n)", "O(1)"],
  },
  {
    id: 7,
    question:
      "How Many Times is the Array [8,7,6,5,4] Passed On During Bubble Sort?",
    answer: "4",
    options: ["0", "5", "4", "6"],
  },
  {
  ...
  },
  {
    id: 11,
    question:
      "Which Method is the Conventional Java Method For Comparing Two Objects For Equailty?",
    answer: "EQUALS()",
  ...
  },
  {
    id: 16,
    question:
      "Members of a Base Class That are Declared Private are Accessible to Which Classes?",
