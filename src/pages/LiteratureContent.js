...
const LITERATURE_CARDS = [
  ...
  },
  {
    ...
    options: ["Appeal to the Reader's Confusion", "Appeal to the Reader's Judgement","Appeal to the Reader's Fears", "Appeal to the Reader's Senses"]
  },
  {
    id: 6,
  ...
  {
    id: 10,
    question: 'What is the Name of a Word that Adds Meaning to the Basic Meaning of the Main Verb?',
    answer: 'Auxiliary Verb',
    options: ['Auxiliary Verb', 'Transitive Verb', 'Stative Verb', 'Intransitive Verb']
  },
  {
    id: 11,
  ...
  },
  {
    ...
    options: ['Masculine, Feminine, Neutral, Singular, Plural', 'Descriptive, Limiting, Proper, Degree, Functional', 'Proper, Common, Concrete, Abstract, Collective']
  },
  {
    id: 13,
    question: 'What Are the Five Types of Adverbs?',
    answer: 'Time, Place, Manner, Degree, Numeral, Interrogative',
    options: ['Proper, Common, Concrete, Abstract, Collective', 'Descriptive, Limiting, Proper, Degree, Functional','Time, Place, Manner, Degree, Numeral, Interrogative']
  },
  {
    id: 14,
  ...
  {
    id: 15,
    question: 'Which Type of Word Shows a Relationship Between a Noun or a Pronoun in a Sentence?',
    answer: 'Preposition',
